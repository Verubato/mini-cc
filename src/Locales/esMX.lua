...
L:RegisterLocale("esMX", {
	...
	["Enable this module in battlegrounds."] = "Habilitar este módulo en campos de batalla.",
	["Enable this module in dungeons."] = "Habilitar este módulo en mazmorras.",
	["Enable this module in raids."] = "Habilitar este módulo en bandas.",
	...
	["Enable pet frame CC in dungeons."] = "Activar CC del marco de mascota en mazmorras.",
	["Enable pet frame CC in raids."] = "Activar CC del marco de mascota en bandas.",
	...
	-- Kick Timer tab
	["As of 12.0.5, the caster of an interrupt can no longer be identified. This module now just displays a generic icon using the shortest known enemy kick cooldown."] = "A partir del parche 12.0.5, ya no se puede identificar quién lanza una interrupción. Este módulo ahora solo muestra un ícono genérico basado en el tiempo de reutilización de interrupción enemigo más corto conocido.",
...
["Excludes yourself from being tracked."] = "Te excluye del seguimiento.",
	...
	["Powerful icon skinning tool."] = "Potente herramienta para personalizar el aspecto de los íconos.",
})
