...
L:RegisterLocale("zhTW", {
	...
	["Enable this module in battlegrounds."] = "在戰場中啟用此模組。",
	["Enable this module in dungeons."] = "在地城中啟用此模組。",
	["Enable this module in raids."] = "在團隊副本中啟用此模組。",
	["Exclude self"] = "排除自己",
	["Glow icons"] = "圖示發光",
	["Glow Type"] = "發光類型",
	["Grow"] = "增長",
	...
	["Enable pet frame CC in dungeons."] = "在地城啟用寵物框架控制圖示。",
	["Enable pet frame CC in raids."] = "在團隊副本啟用寵物框架控制圖示。",
	...
	-- Kick Timer tab
	["As of 12.0.5, the caster of an interrupt can no longer be identified. This module now just displays a generic icon using the shortest known enemy kick cooldown."] = "自12.0.5起，已無法識別打斷的施放者。此模組現在只會根據已知最短的敵方打斷冷卻時間顯示一個通用圖示。",
	["Kick timer"] = "斷法計時器",
	["Kick timer_Short"] = "打斷",
