...
L:RegisterLocale("itIT", {
	...
	["Enable this module in battlegrounds."] = "Abilita questo modulo nei campi di battaglia.",
	["Enable this module in dungeons."] = "Abilita questo modulo nelle spedizioni.",
	["Enable this module in raids."] = "Abilita questo modulo nelle incursioni.",
	...
	["Enable pet frame CC in dungeons."] = "Abilita CC del riquadro pet nelle spedizioni.",
	["Enable pet frame CC in raids."] = "Abilita CC del riquadro pet nelle incursioni.",
	...
	-- Kick Timer tab
	["As of 12.0.5, the caster of an interrupt can no longer be identified. This module now just displays a generic icon using the shortest known enemy kick cooldown."] = "Dalla patch 12.0.5 non è più possibile identificare chi ha lanciato un'interruzione. Questo modulo ora mostra semplicemente un'icona generica basata sul tempo di recupero di interruzione nemico più breve conosciuto.",
