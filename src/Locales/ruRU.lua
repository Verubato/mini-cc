...
L:RegisterLocale("ruRU", {
	...
	["Enable this module in battlegrounds."] = "Включить этот модуль на полях боя.",
	["Enable this module in dungeons."] = "Включить этот модуль в подземельях.",
	["Enable this module in raids."] = "Включить этот модуль в рейдах.",
	...
	["Enable pet frame CC in dungeons."] = "Включить КО рамки питомца в подземельях.",
	["Enable pet frame CC in raids."] = "Включить КО рамки питомца в рейдах.",
