...
L:RegisterLocale("deDE", {
	...
	["Enable this module in battlegrounds."] = "Aktiviere dieses Modul in Schlachtfeldern.",
	["Enable this module in dungeons."] = "Aktiviere dieses Modul in Dungeons.",
	["Enable this module in raids."] = "Aktiviere dieses Modul in Schlachtzügen.",
	...
	["CC"] = "CC",
	["Crowd Control"] = "CC",
	["Change the colour of the glow/border based on dispel type (e.g., blue for magic, red for physical). This only applies to CC icons."] = "Ändere die Farbe des Leuchtens/Rahmens basierend auf dem Banntyp (z.B. blau für Magie, rot für physisch). Dies gilt nur für Massenkontroll-Symbole.",
	...
	["Enable pet frame CC everywhere."] = "Begleiterrahmen-Massenkontrolle überall aktivieren.",
	["Enable pet frame CC in the open world."] = "Begleiterrahmen-Massenkontrolle in der offenen Welt aktivieren.",
	["Enable pet frame CC in arena."] = "Begleiterrahmen-Massenkontrolle in der Arena aktivieren.",
	["Enable pet frame CC in battlegrounds."] = "Begleiterrahmen-Massenkontrolle auf Schlachtfeldern aktivieren.",
	["Enable pet frame CC in dungeons."] = "Begleiterrahmen-Massenkontrolle in Dungeons aktivieren.",
	["Enable pet frame CC in raids."] = "Begleiterrahmen-Massenkontrolle in Schlachtzügen aktivieren.",
