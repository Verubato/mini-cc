...
---isCrowdControl: when true, marks the aura as HARMFUL|CROWD_CONTROL (e.g. Dispersion).
local function buildWatcher(unit, auraIsDefensive, isExternal, isImportant, isCrowdControl)
    ...
    -- HARMFUL|CROWD_CONTROL defaults to filtered-out in the test framework.
    -- Explicitly mark as CC (not filtered) only when the spell is a crowd control.
...
local function runTest(tc)
    ...
    local watcher = buildWatcher(tc.unit, tc.auraIsDefensive, tc.isExternal, tc.isImportant, tc.isCrowdControl)
...
local cases = {
    ...
    },
    {
        ...
        auraIsDefensive = true, isExternal = false, isImportant = true, isCrowdControl = true,
        evidence = {},
    },
    {
        desc = "Shadow Priest - Dispersion (47585) + Heightened Alteration (+2s)",
        unit = "player", class = "PRIEST", specId = 258,
        spellId = 47585, buffDuration = 8,
        auraIsDefensive = true, isExternal = false, isImportant = true, isCrowdControl = true,
        evidence = {},
    ...
    {
        desc = "Blood DK - Vampiric Blood +2s Goreringers Anguish rank 1 (55233, 12s)",
        unit = "player", class = "DEATHKNIGHT", specId = 250,
        spellId = 55233, buffDuration = 12,
        auraIsDefensive = true, isExternal = false, isImportant = true,
        evidence = {},
    },
    {
        desc = "Blood DK - Vampiric Blood +4s Goreringers Anguish rank 2 (55233, 14s)",
        unit = "player", class = "DEATHKNIGHT", specId = 250,
        spellId = 55233, buffDuration = 14,
        auraIsDefensive = true, isExternal = false, isImportant = true,
        evidence = {},
    },
    ...
    {
        desc = "Windwalker Monk - Fortifying Brew (115203) via class rule",
        unit = "player", class = "MONK", specId = 269,
        spellId = 115203, buffDuration = 15,
        auraIsDefensive = true, isExternal = false, isImportant = false,
        evidence = {},
    },

    -- DEMON HUNTER - Devourer spec Blur (Important=false variant)
    {
        desc = "Devourer DH - Blur (198589, Important=false spec rule)",
        unit = "player", class = "DEMONHUNTER", specId = 1480,
        spellId = 198589, buffDuration = 10,
        auraIsDefensive = true, isExternal = false, isImportant = false,
        evidence = {},
    },
