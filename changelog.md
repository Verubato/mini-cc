...
Fixed devastation kick cooldown (was 40 seconds, now 20 seconds).
...
Attempt at fixing the spell alerts showing garbage spells.

## 2.10.0b-7

Various bug fixes for nameplates and spell alerts.

## 2.10.0b-6

Fixed sometimes showing friendly CC on enemies in spell alerts.
...
- Added new "Healer in CC" feature.
- Reverse cooldown sweep option.
- Consolidated world settings into arena.
